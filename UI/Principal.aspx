<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Principal.Master" AutoEventWireup="true" CodeFile="Principal.aspx.cs" Inherits="Principal" %>
...
<%--            <asp:Label ID="Label_NOMBRE_MODULO" runat="server"></asp:Label>--%>
    ...
    <div style="position: relative; margin-top: 40px;" class="text-center">
        <div class="caja1">
            <a href="Negocio/comercial/Tablero.aspx" class="btn btn-default btn-circle cslMer"><i class="icon-mercadeo_n">
