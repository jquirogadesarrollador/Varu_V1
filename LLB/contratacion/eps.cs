...
namespace Brainsbits.LLB.contratacion
{
    public class eps
    {
        ...
        public eps(String idEmpresa, String usuario)
        {
            Empresa = idEmpresa;
            Usuario = usuario;
        }
        ...
        public Boolean Actualizar(Decimal ID_EPS, String NIT, String DIG_VER, String COD_ENTIDAD, String NOM_ENTIDAD, String DIR_ENTIDAD,
            String TEL_ENTIDAD, String CONTACTO, String CARGO, bool ESTADO)
        {
            ...
            sql = "usp_con_ent_eps_actualizar ";
            ...
            {
                sql += ID_EPS + ", ";
                informacion += "ID_EPS = '" + ID_EPS + "', ";
            }
            else
            {
                MensajeError += "El campo ID_EPS no puede ser 0\n";
                ejecutar = false;
            }
        ...
        public DataTable ObtenerTodasLasEPS()
        {
            Conexion conexion = new Conexion(Empresa);
            ...
            sql = "usp_con_ent_eps_obtenerTodas ";
        ...
        public DataTable ObtenerPorNombre(String NOMBRE)
        {
            ...
            sql = "usp_con_ent_eps_obtenerPorNombre ";
        ...
        public DataTable ObtenerPorIdEPS(Decimal ID_EPS)
        {
            Conexion conexion = new Conexion(Empresa);
            DataSet _dataSet = new DataSet();
            DataView _dataView = new DataView();
            ...
            sql = "usp_con_ent_eps_obtenerPorIdEPS ";
        ...
        public DataTable ObtenerPorCiudad(String CIUDAD)
        {
            ...
            sql = "usp_con_ent_eps_obtenerTodas_por_ciudad ";
        ...
        public DataTable ObtenerPorEPSPorIdEmpleado(Decimal idEmpleado)
        {
            Conexion conexion = new Conexion(Empresa);
            DataSet _dataSet = new DataSet();
            DataView _dataView = new DataView();
            ...
            sql = "usp_con_ent_eps_obtenerPorIdEmpleado ";
            sql += idEmpleado;
