...
namespace Brainsbits.LLB.contratacion
{
    public class llamadoAtencion
    {
        ...
        public llamadoAtencion(String idEmpresa, String usuario)
        {
            Empresa = idEmpresa;
            Usuario = usuario;
        }
        ...
        public Decimal Adicionar(Decimal ID_SOLICITUD, DateTime FECHA_R, String OBS_REG)
        {
            String sql = null;
            String ID = null;
            ...
            sql = "usp_reg_llamados_atencion_adicionar ";
            ...
            if (ejecutar)
            {
                ...
                try
                {
                    ...
                    if (!(_auditoria.Adicionar(Usuario, tabla.REG_LLAMADOS_ATENCION, tabla.ACCION_ADICIONAR, sql, informacion, conexion))) ejecutadoCorrectamente = false;
                    #endregion auditoria
        ...
        public Boolean Actualizar(Decimal REGISTRO, Decimal ID_SOLICITUD, DateTime FECHA_R, String OBS_REG)
        {
            String sql = null;
            String informacion = null;
            Boolean ejecutar = true;
            ...
            sql = "usp_reg_llamados_atencion_actualizar ";
            ...
            if (ejecutar)
            {
                ...
                try
                {
                    ...
                    #region auditoria
                    auditoria _auditoria = new auditoria(Empresa);
                    if (!(_auditoria.Adicionar(Usuario, tabla.REG_LLAMADOS_ATENCION, tabla.ACCION_ACTUALIZAR, sql, informacion, conexion))) ejecutadoCorrectamente = false;
                    #endregion auditoria
        ...
        public DataTable ObtenerPorRegistro(Decimal REGISTRO)
        {
            ...
            sql = "usp_reg_llamados_atencion_obtenerPorRegistro ";
        ...
        public DataTable ObtenerPorIdSolicitud(Decimal ID_SOLICITUD)
        {
            Conexion conexion = new Conexion(Empresa);
            DataSet _dataSet = new DataSet();
            DataView _dataView = new DataView();
            ...
            sql = "usp_reg_llamados_atencion_obtenerPorIdSolicitud ";
