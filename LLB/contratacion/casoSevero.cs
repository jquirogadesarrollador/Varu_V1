...
namespace Brainsbits.LLB.contratacion
{
    public class casoSevero
    {
        ...
        public casoSevero(String idEmpresa, String usuario)
        {
            Empresa = idEmpresa;
            Usuario = usuario;
        }
        ...
        public Decimal Adicionar(Decimal ID_EMPLEADO, DateTime FECHA_R, String OBS_REG)
        {
            ...
            sql = "usp_reg_gestantes_casos_severos_adicionar ";
            ...
            if (ejecutar)
            {
                ...
                try
                {
                    ...
                    if (!(_auditoria.Adicionar(Usuario, tabla.REG_GESTANTES_CASOS_SEVEROS, tabla.ACCION_ADICIONAR, sql, informacion, conexion))) ejecutadoCorrectamente = false;
                    #endregion auditoria
        ...
        public Boolean Actualizar(Decimal REGISTRO, Decimal ID_EMPLEADO, DateTime FECHA_R, String OBS_REG)
        {
            ...
            sql = "usp_reg_gestantes_casos_severos_actualizar ";
            ...
            if (ejecutar)
            {
                ...
                try
                {
                    ...
                    #region auditoria
                    auditoria _auditoria = new auditoria(Empresa);
                    if (!(_auditoria.Adicionar(Usuario, tabla.REG_GESTANTES_CASOS_SEVEROS, tabla.ACCION_ACTUALIZAR, sql, informacion, conexion))) ejecutadoCorrectamente = false;
                    #endregion auditoria
        ...
        public DataTable ObtenerPorRegistro(Decimal REGISTRO)
        {
            ...
            sql = "usp_reg_gestantes_casos_severos_obtenerPorRegistro ";
        ...
        public DataTable ObtenerPorIdEmpleado(Decimal ID_EMPLEADO)
        {
            ...
            sql = "usp_reg_gestantes_casos_severos_ObtenerPorIdEmpleado ";
