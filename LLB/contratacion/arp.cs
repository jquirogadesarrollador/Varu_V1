...
namespace Brainsbits.LLB.contratacion
{
    public class arp
    {
        ...
        public arp(String idEmpresa, String usuario)
        {
            Empresa = idEmpresa;
            Usuario = usuario;
        }
        ...
        public Boolean Actualizar(Decimal ID_ARP, String NIT, String DIG_VER, String COD_ENTIDAD, String NOM_ENTIDAD, String DIR_ENTIDAD,
            String TEL_ENTIDAD, String CONTACTO, String CARGO, bool ESTADO)
        {
            ...
            sql = "usp_con_ent_arp_actualizar ";
            ...
            {
                sql += ID_ARP + ", ";
                informacion += "ID_ARP = '" + ID_ARP + "', ";
            }
            else
            {
                MensajeError += "El campo ID_ARP no puede ser 0\n";
                ejecutar = false;
            }
            ...
            if (ejecutar)
            {
                ...
                try
                {
                    ...
                    #region auditoria
                    auditoria _auditoria = new auditoria(Empresa);
                    if (!(_auditoria.Adicionar(Usuario, tabla.CON_AFILIACION_ARP, tabla.ACCION_ACTUALIZAR, sql, informacion, conexion))) ejecutadoCorrectamente = false;
                    #endregion auditoria
        ...
        public DataTable ObtenerTodasLasARP()
        {
            Conexion conexion = new Conexion(Empresa);
            ...
            sql = "usp_con_ent_arp_obtenerTodas ";
        ...
        public DataTable ObtenerPorNombre(String NOMBRE)
        {
            ...
            sql = "usp_con_ent_arp_obtenerPorNombre ";
            ...
            if (ejecutar)
            {
                try
                {
                    ...
                    #region auditoria
                    auditoria _auditoria = new auditoria(Empresa);
                    _auditoria.Adicionar(Usuario, tabla.CON_ENT_ARP, tabla.ACCION_CONSULTAR.ToString(), sql, informacion, conexion);
                    #endregion auditoria
        ...
        public DataTable ObtenerPorIdARP(Decimal ID_ARP)
        {
            Conexion conexion = new Conexion(Empresa);
            DataSet _dataSet = new DataSet();
            DataView _dataView = new DataView();
            ...
            sql = "usp_con_ent_arp_obtenerPorIdARP ";
        ...
        public DataTable ObtenerPorCiudad(String CIUDAD)
        {
            ...
            sql = "usp_con_ent_arp_obtenerTodas_por_ciudad ";
        ...
        public DataTable ObtenerPorARLPorIdEmpleado(Decimal idEmpleado)
        {
            Conexion conexion = new Conexion(Empresa);
            DataSet _dataSet = new DataSet();
            DataView _dataView = new DataView();
            ...
            sql = "usp_con_ent_arl_obtenerPorIdEmpleado ";
            sql += idEmpleado;
