...
{
    public class parametroIncapacidad
    {
        #region variables
        ...
        public parametroIncapacidad(String idEmpresa, String usuario)
        {
            Empresa = idEmpresa;
            Usuario = usuario;
        }
        ...
        public Decimal Adicionar(String CLASE_INCAPACIDAD, Decimal ID_CONCEPTO, Decimal ID_CONCEPTO_TRES_DIAS, Decimal PORCENTAJE)
        {
            ...
            if (ejecutar)
            {
                ...
                try
                {
                    ...
                    if (!(_auditoria.Adicionar(Usuario, tabla.PAR_INCAPACIDADES, tabla.ACCION_ADICIONAR, sql, informacion, conexion))) ejecutadoCorrectamente = false;
                    #endregion auditoria
        ...
        public DataTable ObtenerTodas()
        {
            ...
            sql = "usp_par_incapacidades_obtenerTodos ";
        ...
        public DataTable ObtenerPorClaseIncapacidad(String CLASE_INCAPACIDAD)
        {
            Conexion conexion = new Conexion(Empresa);
            DataSet _dataSet = new DataSet();
            DataView _dataView = new DataView();
            ...
            sql = "usp_par_incapacidades_obtenerPorClaseIncapacidad " + CLASE_INCAPACIDAD;
